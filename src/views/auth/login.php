...
<body>
    <h2>Login</h2>
    <form action="/iods/login" method="POST">
        <div>
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
                ...
                <div class="card-body">
                    ...
                    <form action="/iods/login" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" class="form-control" placeholder="Enter username" autocomplete="on" required>
                        </div>
                        <div class="mb-2">
            ...
            <div class="text-center text-secondary mt-3">
                Don't have account yet? <a href="/iods/register" tabindex="-1">Sign up</a>
            </div>
        </div>
    </div>
    <!-- Libs JS -->
